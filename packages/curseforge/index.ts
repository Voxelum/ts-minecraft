...
export class CurseforgeV1Client {
  ...
  async getCategories(signal?: AbortSignal) {
    const url = new URL(this.baseUrl + '/v1/categories', this.baseUrl)
  ...
  async getMod(modId: number, signal?: AbortSignal) {
    const url = new URL(this.baseUrl + `/v1/mods/${modId}`, this.baseUrl)
    const response = await fetch(url, {
      headers: {
        accept: 'application/json',
        ...this.headers,
  ...
  async getModDescription(modId: number, signal?: AbortSignal) {
    const url = new URL(this.baseUrl + `/v1/mods/${modId}/description`, this.baseUrl)
    const response = await fetch(url, {
      headers: {
        ...this.headers,
        accept: 'application/json',
  ...
  async getModFiles(options: GetModFilesOptions, signal?: AbortSignal) {
    const url = new URL(this.baseUrl + `/v1/mods/${options.modId}/files`, this.baseUrl)
  ...
  async getModFile(modId: number, fileId: number, signal?: AbortSignal) {
    const url = new URL(this.baseUrl + `/v1/mods/${modId}/files/${fileId}`, this.baseUrl)
    const response = await fetch(url, {
      headers: {
        ...this.headers,
        accept: 'application/json',
  ...
  async getMods(modIds: number[], signal?: AbortSignal) {
    const url = new URL(this.baseUrl + '/v1/mods', this.baseUrl)
    const response = await fetch(url, {
      method: 'POST',
  ...
  async getFiles(fileIds: number[], signal?: AbortSignal) {
    const url = new URL(this.baseUrl + '/v1/mods/files', this.baseUrl)
    const response = await fetch(url, {
      method: 'POST',
  ...
  async searchMods(options: SearchOptions, signal?: AbortSignal) {
    const url = new URL(this.baseUrl + '/v1/mods/search', this.baseUrl)
    url.searchParams.append('gameId', '432')
